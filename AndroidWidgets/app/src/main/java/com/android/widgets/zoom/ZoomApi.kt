 ...
 */
const val ALIGNMENT_DEFAULT = ZoomAlignment.CENTER
...
interface ZoomApi {
    ...
    /**
     * Sets the content alignment. Can be any of the constants defined in [com.kantek.pallettracksignature.widgets.zoom.ZoomAlignment].
...
@Retention(AnnotationRetention.SOURCE)
@IntDef(
    ZoomAlignment.BOTTOM,
    ZoomAlignment.CENTER_VERTICAL,
    ZoomAlignment.NONE_VERTICAL,
    ZoomAlignment.TOP,
    ZoomAlignment.LEFT,
    ZoomAlignment.CENTER_HORIZONTAL,
    ZoomAlignment.NONE_HORIZONTAL,
    ZoomAlignment.RIGHT,
