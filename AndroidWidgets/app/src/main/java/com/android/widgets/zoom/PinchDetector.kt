...
internal class PinchDetector(
    ...
    private fun handleOnScaleEnd() {
        ...
        @RealZoom val maxZoom = zoomManager.getMaxZoom()
        @RealZoom val minZoom = zoomManager.getMinZoom()
        // check what zoom needs to be applied to get into a non-overpinched state
        @RealZoom val newZoom = zoomManager.checkBounds(matrixController.zoom, allowOverZoom = false)
