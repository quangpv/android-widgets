...
internal class ScrollFlingDetector(
    ...
    override fun onFling(e1: MotionEvent?, e2: MotionEvent?, velocityX: Float, velocityY: Float): Boolean {
        ...
        @ScaledPan val minX = panStatusX.minValue
        @ScaledPan val startX = panStatusX.currentValue
        @ScaledPan val maxX = panStatusX.maxValue
        @ScaledPan val minY = panStatusY.minValue
        @ScaledPan val startY = panStatusY.currentValue
        @ScaledPan val maxY = panStatusY.maxValue
        ...
        @ScaledPan val overScrollX = if (panManager.horizontalOverPanEnabled) panManager.maxOverPan else 0F
        @ScaledPan val overScrollY = if (panManager.verticalOverPanEnabled) panManager.maxOverPan else 0F
    ...
    override fun onScroll(
        e1: MotionEvent?,
        e2: MotionEvent?,
        @ScaledPan distanceX: Float,
        @ScaledPan distanceY: Float
    ): Boolean {
